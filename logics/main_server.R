box::use(
    ...
    tibble[tbl = tibble],                          # fix: tibble comes from tibble, not dplyr
    ggplot2[
    ...
    ./core/sampler,
    ./core/params,
    pdf_parser = ./core/pdf_parser_temp
)
...
server = function(id) {
    moduleServer(id, function(input, output, session) {
        ...
        # Removed: debug observe block
        # Removed: reactive/observe/bindEvent imports no longer needed
